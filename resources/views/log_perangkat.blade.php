    ...
    <div class="card shadow-sm p-4">
        {{-- Tombol dan Pencarian --}}
            ...
            <div class="d-flex gap-2 align-items-center flex-wrap">
                <a href="{{ url('/log_perangkat/export') }}" title="Export Excel" class="btn btn-outline-success btn-sm">
                    <i class="fa fa-download"></i>
                </a>
                <a href="#" title="Import Excel" data-bs-toggle="modal" data-bs-target="#importModal" class="btn btn-outline-primary btn-sm">
                    <i class="fa fa-upload"></i>
                </a>
                <a href="#" title="Tambah Data" data-bs-toggle="modal" data-bs-target="#tambahModal" class="btn btn-outline-success btn-sm">
                    <i class="fa fa-plus"></i>
                </a>
            </div>

            {{-- Form pencarian kanan --}}
            <form method="GET" action="{{ route('log_perangkat') }}">
